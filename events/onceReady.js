        ...
        (async () => {
            try {
                if (global == true) {
                    ...
                    await console.log(`${getTime(new Date())} | Succesfully loaded application commands in ${guilds.size} servers.`);
                }
                else {
                    rest.put(Routes.applicationGuildCommands(clientID, guildID), {
                        body: commands
                    })
                    await console.log(`${getTime(new Date())} | Succesfully loaded application commands locally.`);
                }
            }
            catch (error) {
